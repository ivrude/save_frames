...
# Налаштування
RTSP_URL = "rtsp://admin:p@ssw0rd@192.168.0.34:554"  # Замініть на свою RTSP-URL
SAVE_DIR = "Parishev"
FRAMES_TO_CAPTURE = 5
...
def capture_grafana_screenshot(folder):
    with sync_playwright() as p:
        ...
        page.goto("http://192.168.0.5:3000/d/ddlsl1eunjugwd122/arm-1-parishiv?orgId=1&refresh=5s")
