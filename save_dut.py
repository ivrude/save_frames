...
# Налаштування
RTSP_URL = "rtsp://admin:p@ssw0rd@192.168.0.44:554"  # Замініть на свою RTSP-URL
SAVE_DIR = "Dutytki"
FRAMES_TO_CAPTURE = 5
GRAFANA_URL = "http://192.168.0.5:3000/d/ddlsl1eunjugwd1/arm-3-ditjatki?orgId=1&refresh=5s&from=1743330695677&to=1743330995677"  # Замініть на правильний URL
